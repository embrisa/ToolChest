...
export const createMockServiceResponse = (locale: string = "en") => ({
  tools:
    mockTranslatedTools[locale as keyof typeof mockTranslatedTools] ||
    mockTranslatedTools.en,
  tags:
    mockTranslatedTags[locale as keyof typeof mockTranslatedTags] ||
    mockTranslatedTags.en,
});
...
const allTranslations: any = {
  ...
  es: {
    ...
    "tools.base64.description":
      "Codifica y decodifica cadenas Base64 fácilmente",
    "tools.hash-generator.name": "Generador de Hash",
    "tools.hash-generator.description":
      "Genera hashes MD5, SHA1, SHA256 y otros",
    ...
    "tags.encoding.description":
      "Herramientas de codificación de texto y datos",
  ...
  fr: {
    ...
    "tools.base64.description":
      "Encodez et décodez facilement les chaînes Base64",
    "tools.hash-generator.name": "Générateur de Hash",
    "tools.hash-generator.description":
      "Générez des hachages MD5, SHA1, SHA256 et autres",
...
export const mockDatabaseTranslationService = {
  translateTool: jest
    .fn()
    .mockImplementation((tool: any, locale: string = "en") => {
      const result = createTranslatedToolV2(tool, locale);
      return Promise.resolve(result);
    }),
  translateTools: jest
    .fn()
    .mockImplementation((tools: any[], locale: string = "en") =>
      Promise.resolve(
        tools.map((tool) => createTranslatedToolV2(tool, locale)),
      ),
    ),
  translateTag: jest
    .fn()
    .mockImplementation((tag: any, locale: string = "en") => {
      const result = createTranslatedTagV2(tag, locale);
      return Promise.resolve(result);
    }),
  translateTags: jest
    .fn()
    .mockImplementation((tags: any[], locale: string = "en") =>
