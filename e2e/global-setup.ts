        ...
        const testTools = await Promise.all([
            prisma.tool.create({
                data: {
                    ...
                    slug: 'base64',
                    description: 'Encode and decode Base64 text and files with support for URL-safe encoding',
            ...
            prisma.tool.create({
                data: {
                    ...
                    description: 'Convert Markdown documents to styled PDF files with custom themes',
