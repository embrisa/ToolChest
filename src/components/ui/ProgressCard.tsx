...
export function ProgressCard({
    ...
    const showETA = showTimeRemaining &&
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="sr-only" role="status" aria-live="polite">
                            {title || "Progress"}: {Math.round(progress.progress)}% complete. {getStageMessage()}.
                            {showETA ? ` Estimated time remaining: ${progress.estimatedTimeRemaining} seconds.` : ""}
                        </div>
                    </div>
