...
const alertVariants = {
  error: {
    container:
      "bg-error-100 border-error-200 dark:bg-error-950/40 dark:border-error-800",
  ...
  warning: {
    container:
      "bg-warning-100 border-warning-200 dark:bg-warning-950/40 dark:border-warning-800",
  ...
  success: {
    container:
      "bg-success-100 border-success-200 dark:bg-success-950/40 dark:border-success-800",
  ...
  info: {
    container:
      "bg-brand-100 border-brand-200 dark:bg-brand-950/40 dark:border-brand-800",
