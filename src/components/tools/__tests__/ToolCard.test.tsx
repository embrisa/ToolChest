  ...
  describe("Accessibility", () => {
    it("should have proper ARIA labels", () => {
      ...
      const hasAccessibleName =
        ...
        link.textContent?.includes("Base64 Encoder/Decoder");
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle very long descriptions", () => {
      const toolWithLongDescription = {
        ...mockTool,
        description:
          "This is a very long description that goes on and on and might cause layout issues if not properly truncated or handled in the UI component design system",
      };

      render(<ToolCard tool={toolWithLongDescription} />);

      expect(
        screen.getByText(toolWithLongDescription.description),
      ).toBeInTheDocument();
    });
