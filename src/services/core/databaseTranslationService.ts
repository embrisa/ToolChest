...
export class DatabaseTranslationService {
  ...
  static async translateTool(
    ...
    const name = (tool as any).nameKey ? t((tool as any).nameKey) : tool.slug;
    const description = (tool as any).descriptionKey
      ? t((tool as any).descriptionKey)
      : null;
  ...
  static async translateTag(
    ...
    const name = (tag as any).nameKey ? t((tag as any).nameKey) : tag.slug;
    const description = (tag as any).descriptionKey
      ? t((tag as any).descriptionKey)
      : null;
