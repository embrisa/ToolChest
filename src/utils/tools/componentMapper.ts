...
const HashGeneratorTool = lazy(() => import("@/components/tools/HashGeneratorTool").then(module => ({ default: module.HashGeneratorTool })));
const FaviconGeneratorTool = lazy(() => import("@/components/tools/FaviconGeneratorTool").then(module => ({ default: module.FaviconGeneratorTool })));
const MarkdownToPdfTool = lazy(() => import("@/components/tools/MarkdownToPdfTool").then(module => ({ default: module.MarkdownToPdfTool })));
