...
import { locales, type Locale, isValidLocale } from "@/utils/i18n/modularTranslations";
 ...
 */
export function createLocaleCookieHeaders(locale: Locale): Record<string, string> {
    return {
