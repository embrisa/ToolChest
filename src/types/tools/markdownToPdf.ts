 ...
 * PDF styling theme
 */
export type PdfTheme = 'default' | 'github' | 'academic' | 'minimal' | 'dark' | 'professional';

/**
 * Markdown syntax highlighting theme
 */
export type SyntaxTheme = 'github' | 'monokai' | 'vs' | 'atom-one-dark' | 'rainbow';
 ...
 */
export type PdfFontFamily = 'serif' | 'sans-serif' | 'monospace' | 'times' | 'helvetica' | 'courier';
 ...
 */
export const PDF_FORMAT_DIMENSIONS: Record<PdfFormat, { width: number; height: number }> = {
...
export const PDF_TEMPLATES: PdfTemplate[] = [
    ...
    },
    {
        id: 'academic',
        name: 'Academic',
        description: 'Professional format for research papers and academic documents',
        stylingOptions: {
            theme: 'academic',
            fontSize: 11,
            lineHeight: 1.6,
    ...
    },
    {
        id: 'high-contrast',
        name: 'High Contrast',
        description: 'Accessibility-focused design with high contrast and larger text',
        stylingOptions: {
            theme: 'default',
            fontSize: 14,
            lineHeight: 1.6,
