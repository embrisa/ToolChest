...
/**
 * Default styling options - optimized for professional, polished output
 */
...
export const PDF_TEMPLATES: PdfTemplate[] = [
  ...
  },
  {
    id: "academic",
    name: "Academic",
    description: "Professional format for research papers and essays",
    stylingOptions: {
      theme: "academic",
      fontSize: 12,
      lineHeight: 1.8,
  ...
  },
  {
    id: "professional",
    name: "Professional",
    description: "Business-ready format with branded headers",
    stylingOptions: {
      theme: "professional",
      fontSize: 12,
      lineHeight: 1.6,
  ...
  },
  {
    id: "high-contrast",
    name: "High Contrast",
    description: "Accessibility-focused with larger text and high contrast",
    stylingOptions: {
      theme: "default",
      fontSize: 16,
      lineHeight: 1.8,
  ...
  },
  {
    id: "dark",
    name: "Dark Mode",
    description: "Sleek dark theme for modern documents",
    stylingOptions: {
      theme: "dark",
      fontSize: 14,
      lineHeight: 1.7,
