 ...
 */
export const HTTP_ERROR_CONFIGS: Record<number, Omit<ErrorPageProps, 'statusCode'>> = {
    400: {
        title: 'Bad Request',
        message: 'The request could not be understood',
        description: 'There was an issue with the data you submitted. Please check your input and try again.',
        suggestions: [
    ...
    404: {
        ...
        description: 'The page you requested could not be found. It may have been moved, deleted, or you may have typed the URL incorrectly.',
        suggestions: [
    ...
    502: {
        ...
        description: 'We\'re experiencing connectivity issues. Please try again in a few moments.',
        suggestions: [
            'Wait a few minutes and try again',
    ...
    503: {
        ...
        description: 'We\'re performing scheduled maintenance. The service will be back online shortly.',
        suggestions: [
            'Wait a few minutes and try again',
