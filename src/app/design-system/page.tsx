          ...
          <div className="flex items-start justify-between">
            <div className="max-w-4xl">
              ...
              <p className="text-body text-lg text-secondary max-w-3xl leading-relaxed">
                A comprehensive showcase of our entire UI component library,
                featuring enhanced accessibility, WCAG AAA compliance, modern
                interactions, and developer-focused APIs.
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="container-wide section-spacing-lg space-y-32">
        ...
        <section>
          <div className="mb-12">
            ...
            <p className="text-body text-lg text-secondary max-w-4xl">
              Core building blocks that form the foundation of our design
              system. These components are used throughout the application and
          ...
          {/* Button System */}
          <div className="mb-16">
            <h3 className="text-heading text-2xl font-semibold text-primary mb-8">
              Button Components
            </h3>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card variant="default" padding="md">
                ...
                <CardContent>
                  <p>
                    Enhanced spacing with proper background hierarchy and subtle
                    shadows for optimal content presentation.
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card variant="interactive" padding="md">
                ...
                <CardContent>
                  <p>
                    Hover effects with elevation changes. Background transitions
              ...
              <Card variant="glass" padding="md" className="backdrop-blur-xl">
                ...
                <CardContent>
                  <p>
                    Modern glassmorphism with backdrop blur and subtle
        ...
        <section>
          <div className="mb-12">
            ...
            <p className="text-body text-lg text-secondary max-w-4xl">
              Sophisticated input components for complex data entry and
              selection scenarios, with full accessibility support and smooth
              interactions.
            </p>
          </div>
        ...
        <section>
          <div className="mb-12">
            ...
            <p className="text-body text-lg text-secondary max-w-4xl">
              Components for communicating system status, progress, and user
              feedback with clear visual hierarchy and accessibility support.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card
                padding="md"
                className="border-l-4 border-l-success-500 bg-success-50"
              >
              ...
              <Card
                padding="md"
                className="border-l-4 border-l-error-500 bg-error-50"
              >
                <div className="flex items-center space-x-2 mb-3">
              ...
              <Card
                padding="md"
                className="border-l-4 border-l-brand-500 bg-brand-50"
              >
                <div className="flex items-center space-x-2 mb-3">
            ...
            <div className="mt-8">
              <p className="text-sm text-secondary mb-4">
                Toast notifications support actions, persistence, custom
                duration, and accessibility features.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="mb-12">
            ...
            <p className="text-body text-lg text-secondary max-w-4xl">
              Sophisticated loading states and skeleton screens that maintain
              layout structure and provide excellent user experience during data
              fetching.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <Card padding="md">
                    <h5 className="text-sm font-medium text-secondary mb-3">
                      Text Skeleton
                    </h5>
              ...
              <div>
                ...
                <div className="space-y-8">
                  <div>
                    <h5 className="text-sm font-medium text-secondary mb-4">
                      Tool Card Skeleton
                    </h5>
        ...
        <section>
          <div className="mb-12">
            ...
            <p className="text-body text-lg text-secondary max-w-4xl">
              High-performance components optimized for Core Web Vitals, with
              intelligent loading strategies and image optimization.
            </p>
          </div>
              ...
              <Card padding="md">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-secondary">
                    Automatic WebP/AVIF conversion, responsive sizing, and lazy
                    loading
                  </p>
                </div>
              </Card>
        ...
        <section>
          <div className="mb-12">
            ...
            <p className="text-body text-lg text-secondary max-w-4xl">
              Professional light theme design with accessibility features that
        ...
        <section>
          <div className="mb-12">
            ...
            <p className="text-body text-lg text-secondary max-w-4xl">
              TypeScript-first components with comprehensive APIs, excellent
              developer experience, and extensive customization options.
            </p>
          </div>
        ...
        <section className="text-center section-spacing-lg border-t border-neutral-200">
          <div className="mb-8">
            ...
            <p className="text-body text-lg text-secondary max-w-4xl mx-auto leading-relaxed">
              Our comprehensive UI component library provides everything you
              need to build beautiful, accessible, and performant user
              interfaces. All components are TypeScript-first, WCAG AAA
              compliant, and optimized for modern web standards.
            </p>
          </div>
