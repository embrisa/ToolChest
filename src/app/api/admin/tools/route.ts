...
export async function GET(request: NextRequest) {
    try {
        ...
        const sortOptions: AdminToolsSortOptions = {
            field: (searchParams.get('sortField') as AdminToolsSortOptions['field']) || 'displayOrder',
        ...
        const tools = await adminToolService.getAllToolsForAdmin(sortOptions, filters);
