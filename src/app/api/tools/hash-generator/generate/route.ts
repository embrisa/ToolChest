...
const ALLOWED_FILE_TYPES = [
    'text/plain', 'application/json', 'text/csv', 'text/html', 'text/xml',
    'application/xml', 'image/jpeg', 'image/png', 'image/gif', 'image/webp',
...
async function handleTextHashing(request: NextRequest) {
    try {
        ...
        const hash = crypto.createHash(nodeAlgorithm).update(text, 'utf8').digest('hex');
